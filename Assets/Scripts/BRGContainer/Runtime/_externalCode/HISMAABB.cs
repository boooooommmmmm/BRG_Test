...
/// </remarks>
[System.Serializable]
public struct HISMAABB : IEquatable<HISMAABB>
{
    /// <summary>
    ...
    public HISMAABB(float3 min, float3 max)
    {
        Min = min;
        Max = max;
    }

    public HISMAABB(bool init)
    {
        Min = float.MaxValue;
        Max = float.MinValue;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static HISMAABB CreateFromCenterAndExtents(float3 center, float3 extents)
    {
    ...
    /// <returns>AABB created from inputs.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static HISMAABB CreateFromCenterAndHalfExtents(float3 center, float3 halfExtents)
    {
        return new HISMAABB(center - halfExtents, center + halfExtents);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool Contains(HISMAABB aabb) => math.all((Min <= aabb.Min) & (Max >= aabb.Max));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool Overlaps(HISMAABB aabb)
    {
    ...
    /// </remarks>
    /// <seealso cref="Contains(Unity.Mathematics.Geometry.HISMAABB)"/>
    /// <param name="aabb">AABB to encapsulate.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Encapsulate(in HISMAABB aabb)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool Equals(HISMAABB other)
    {
    ...
    {
        return string.Format("HISMAABB({0}, {1})", Min, Max);
    }
}
...
internal static partial class Math
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static HISMAABB Transform(RigidTransform transform, HISMAABB aabb)
    {
        ...
        return new HISMAABB(centerInB - halfExtentsInB, centerInB + halfExtentsInB);
    }
    ...
    /// <returns>Transformed AABB.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static HISMAABB Transform(in float4x4 transform, in HISMAABB aabb)
    {
    ...
    /// <returns>Transformed AABB.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static HISMAABB Transform(float3x3 transform, HISMAABB aabb)
    {
        ...
        var minMask = t1 < t2;
        var transformed = new HISMAABB(select(t2, t1, minMask), select(t2, t1, !minMask));
