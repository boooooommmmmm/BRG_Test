namespace BRGContainer.Runtime
{
    ...
    public static class BatchInstanceDataBufferExtensions
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SetMatrix(this BatchInstanceDataBuffer buffer, int index, int propertyId, PackedMatrix matrix)
        {
            buffer.WriteInstanceData(index, propertyId, matrix);
        }
